						...
						<div class="col-md-3">
							<div class="header-logo">
								<a href=<?php echo BASE_URL ?> class="logo">
									<img src="/Proyek-Website-Toko-Buku/Assets/Img/logoweb.png" alt="toko sigma">
								</a>
							</div>
						</div>
						<!-- /LOGO -->
							...
							<div class="header-ctn">
								...
								<div class="dropdown">
									...
									<div class="cart-dropdown">
										...
										<div class="cart-btns">
											<a href="#">View Cart</a>
											<a href=<?php echo BASE_URL . "/pages/checkout.php"?>>Checkout  <i class="fa fa-arrow-circle-right"></i></a>
										</div>
									</div>
								</div>
								<!-- /Cart -->
								...
								<div class="dropdown profile-dropdown-ctn">
									...
									<div class="profile-dropdown">
										<div class="profile-links">
											<a href=<?php echo BASE_URL . "/pages/profile.php"?>><i class="fa fa-user"></i> Profil Saya</a>
											<a href=<?php echo BASE_URL . "/pages/setting.php"?>><i class="fa fa-cog"></i> Pengaturan</a>
											<a href=<?php echo BASE_URL . "/pages/logout.php"?>><i class="fa fa-sign-out"></i> Logout</a>
										</div>
									</div>
								</div>
								<!-- /Profile -->
