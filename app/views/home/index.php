...
style="background-image: url(<?php echo BASE_URL?>/frontend/images/banner1.png); background-size: cover; background-repeat: no-repeat; background-position: center; height: 800px;">
	...
	<div class="swiper-slide">
		...
		<div class="row d-flex flex-column-reverse flex-md-row align-items-center">
			...
			<div class="banner-content">
				...
				<p>Belilah  agar menjadi orang sigma!</p>
				<a href="<?php echo BASE_URL?>/home/allCategory" class="btn mt-3">Katalog</a>
			</div>
			</div>
